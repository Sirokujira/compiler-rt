...
macro(test_targets)
  ...
  elseif(NOT APPLE) # Supported archs for Apple platforms are generated later
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "rx600")
      test_target_arch(rx600 "" "-cpu=rx600")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "rx200")
      test_target_arch(rx600 "" "-cpu=rx200")
    endif()
